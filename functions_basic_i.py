...
def number_of_military_branches():
    return 5
print(number_of_days_in_a_week_silicon_or_triangle_sides() + number_of_military_branches()) # Error since the first part of the print statement isnt a defined function
...
print(x) # 5 then nothing


#6
def add(b,c):
    print(b+c)
print(add(1,2) + add(2,3)) # 3 then 5 then Error
...
def number_of_oceans_or_fingers_or_continents():
    ...
    if b < 10:
        ...
        return 10
    return 7
print(number_of_oceans_or_fingers_or_continents()) # 100 then 10
